window.AcademicBlogData = {
  ...
  publications: [
    ...
    {
      authors: "Pengming Feng, Mingjie Xie, Hongning Liu, Xuanjia Zhao, Guangjun He, Xueliang Zhang, and Jian Guan",
  ...
  posts: [
    {
      title: "如何把读书笔记整理成研究问题",
      date: "2026-07-31",
      category: "方法",
      summary: "从摘录、概念卡片、问题树到论文选题，建立一条可反复使用的笔记转化流程。",
      tags: ["读书笔记", "研究方法", "写作"],
      link: "posts/reading-notes-to-research-questions.html"
    },
    {
      title: "知识图谱在课程资源组织中的作用",
      date: "2026-07-20",
      category: "研究",
      summary: "用节点、关系和证据来源重新组织课程材料，让教学资源可以被检索、复用和扩展。",
      tags: ["知识图谱", "教育技术", "数据"],
      link: "posts/knowledge-graph-course-resources.html"
    },
    {
      title: "一次论文复现实验的记录模板",
      date: "2026-07-12",
      category: "工具",
      summary: "整理实验环境、数据版本、参数、异常情况和结果解释，降低复现时的记忆成本。",
      tags: ["复现", "实验", "模板"],
      link: "posts/reproduction-log-template.html"
    },
    {
      title: "公开写作给学术训练带来的节奏感",
      date: "2026-06-30",
      category: "随笔",
      summary: "把未完成的想法写成短札，有时比等待完整论文更能推动真正的研究进展。",
      tags: ["开放研究", "博客", "学术生活"],
